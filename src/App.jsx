...
function App() {
  ...
  return (
    <Routes>
      ...
      />
      <Route path="/pickup" element={<Navigate to="/pickup-requests" replace />} />
      <Route path="/pickups" element={<Navigate to="/pickup-requests" replace />} />

      {/* Volunteer Dashboard & Task Management */}
      <Route
        path="/volunteer"
        element={
          <VolunteerDashboard
      ...
      <Route path="/volunteer-tasks" element={<Navigate to="/volunteer" replace />} />
